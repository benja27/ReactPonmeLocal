    ...
    <div className="flex-grow-1">
      <div className="container main-section flex-grow-1">
        ...
        <div className="d-flex text-center flex-wrap">
          <figure className="col-12 col-sm-4" ref={(el) => (tiltRefs.current[0] = el)}  >
            <img
          ...
          <figure className="col-12 col-sm-4" ref={(el) => (tiltRefs.current[1] = el)}>
            <img
          ...
          <figure className="col-12 col-sm-4" ref={(el) => (tiltRefs.current[2] = el)}>
            <img
        ...
        <div>
          ...
          <div className="d-flex text-center flex-wrap justify-content-around conti">
            ...
            <figure className="col-6 col-sm-3 col-md-2" ref={(el) => (tiltRefs.current[3] = el)}>
              <img
            ...
            <figure className="col-6 col-sm-3 col-md-2" ref={(el) => (tiltRefs.current[4] = el)} >   
              <img
            ...
            <figure className="col-6 col-sm-3 col-md-2 flex-wrap rounded justify-content-center"  ref={(el) => (tiltRefs.current[5] = el)}  >
            ...
            <figure className="col-6 col-sm-3 col-md-2 d-fle flex-wrap" ref={(el) => (tiltRefs.current[6] = el)}    >
              <img
            ...
            <figure className="col-6 col-sm-3 col-md-2" ref={(el) => (tiltRefs.current[7] = el)}   >
              <img
